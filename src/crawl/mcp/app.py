...
from crawl.sdk import article as sdk_article
...
async def websearch(
    ...
    scrape_limit: int = 3,
    scrape_formats: list[Literal["markdown", "text", "html", "links", "metadata", "app_state", "contacts", "technologies", "article", "api_payloads"]] | None = None,
...
async def scrape(
    url: str,
    formats: list[Literal["markdown", "text", "html", "links", "metadata", "fit_markdown", "app_state", "contacts", "technologies", "article", "api_payloads"]] | None = None,
    only_main_content: bool = True,
    query: str | None = None,
    mode: Literal["auto", "http", "browser"] = "auto",
    initial_cookies: list[dict] | None = None,
...
async def article(
    ...
    """Run the SDK article extraction through the MCP transport."""
    return await sdk_article(
        url=url,
        mode=mode,
        follow_pagination=follow_pagination,
        max_pages=max_pages,
